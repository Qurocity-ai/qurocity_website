...
const PortugueseCurriculum = () => {
  ...
  const modules = {
    A1: [
      {
        title: "Module 1:: Introduction to Portuguese",
        description: [
    ...
    <div className={styles.containerOne}>
      <div className={styles.curriculumSection}>
        ...
        <div className={styles.curriculumBox}>
          ...
          <p>
            <span className={styles.highlight}>Purpose:</span> Standardizes the description of Portuguese language proficiency
          </p>
          <p>
          ...
          <p>
            Our Portuguese course focuses on developing all <span className={styles.bold}>four key skills:</span>{" "}
...
export default PortugueseCurriculum;
