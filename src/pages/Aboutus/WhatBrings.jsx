          ...
          <div className={styles.whatBringContener}>
            ...
            {/* card4 */}
              <div className={styles.whatBringCard}>
                  ...
                  <p><strong>World-class preparation</strong> for globally-recognized language certifications</p>
              </div>
             {/* card 5 */}
              <div className={styles.whatBringCard}>
                  <img src='./about us/group2.jpg' alt='image1' />
            ...
            {/* card 6 */}
              <div className={styles.whatBringCard}>
                  ...
                  <p><strong>Real-time analytics and custom reports</strong> to enhance learning outcomes</p>
              </div>
